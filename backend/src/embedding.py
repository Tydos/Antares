...
class HuggingFaceEmbeddingService:
    # Initialize the HuggingFaceEmbeddingService with the API endpoint for the specified embedding model
    ...
    # Helper method to fetch embeddings for a batch of texts from the HuggingFace API
    ...
    # Embed a list of texts by sending them to the HuggingFace API in batches and returning the resulting embeddings
